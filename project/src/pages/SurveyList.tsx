...
const SurveyList = () => {
  ...
  className="w-full sm:w-auto mt-4 sm:mt-0 group px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors flex items-center justify-center space-x-2"
>
